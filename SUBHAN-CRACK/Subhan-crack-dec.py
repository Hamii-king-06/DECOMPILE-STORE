...
def main_select():
    ...
    if SYED == '':
        ...
        os.system('xdg-open https://www.instagram.com/subhan_tricks')
...
def log_select():
    ...
    if sel == '2':
        ...
        os.system('python2 SubhanXwithout.py')
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                if 'access_token' in q:
                    ...
                    print '\x1b[1;92m[SUBHAN OK] ' + uid + ' | ' + pass2 + ' | ' + name
                    ...
                    print '\x1b[1;93m[SUBHAN] ' + uid + ' | ' + pass2 + ' | ' + name
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;92m[SUBHANOK] ' + uid + ' | ' + pass3 + ' | ' + name
                        ...
                        print '\x1b[1;93m[SUBHAN] ' + uid + ' | ' + pass3 + ' | ' + name
                        ...
                        if 'access_token' in q:
                            ...
                            print '\x1b[1;92m[SUBHANOK] ' + uid + ' | ' + pass4 + ' | ' + name
                            ...
                            print '\x1b[1;93m[SUBHANOK] ' + uid + ' | ' + pass4 + ' | ' + name
                            ...
                            if 'access_token' in q:
                                ...
                                print '\x1b[1;92m[SUBHANOK] ' + uid + ' | ' + pass5 + ' | ' + name
                                ...
                                print '\x1b[1;93m[SUBHAN] ' + uid + ' | ' + pass5 + ' | ' + name
                                ...
                                if 'access_token' in q:
                                    ...
                                    print '\x1b[1;92m[SUBHANOK] ' + uid + ' | ' + pass6 + ' | ' + name
                                    ...
                                    print '\x1b[1;93m[SUBHAN] ' + uid + ' | ' + pass6 + ' | ' + name
                                    ...
                                    if 'access_token' in q:
                                        ...
                                        print '\x1b[1;92m[SUBHAN] ' + uid + ' | ' + pass7 + ' | ' + name
                                        ...
                                        print '\x1b[1;93m[SUBHAN] ' + uid + ' | ' + pass7 + ' | ' + name
        ...
        try:
            ...
            if 'access_token' in q:
                ...
                if 'access_token' in q:
                    ...
                    print '\x1b[1;92m[SUBHANOK] ' + uid + ' | ' + pass2 + ' | ' + name
                    ...
                    if 'access_token' in q:
                        ...
                        print '\x1b[1;92m[SUBHAN] ' + uid + ' | ' + pass3 + ' | ' + name
                        ...
                        if 'access_token' in q:
                            ...
                            print '\x1b[1;93m[SUBHAN] ' + uid + ' | ' + pass4 + ' | ' + name
                            ...
                            if 'access_token' in q:
                                ...
                                if 'access_token' in q:
                                    ...
                                    if 'access_token' in q:
                                        ...
                                        print '\x1b[1;92m[SUBHANOK] ' + uid + ' | ' + pass7 + ' | ' + name
